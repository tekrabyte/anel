    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm mb-4">
              ARTIK NOVA LINDO is a General Contractor with 10 years of experience in construction, renovation, and industrial services.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/solutions" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Solutions
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+6281177659000" className="hover:text-white transition-colors">
                  +62 811 7765 900
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href="mailto:info@anl.co.id" className="hover:text-white transition-colors">
                  info@anl.co.id
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} PT ARTIK NOVA LINDO. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
